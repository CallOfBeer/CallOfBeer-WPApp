...
namespace CallOfBeer.Pages
{
    ...
    public sealed partial class LoginPage : Page
    {
        ...
        {
            if (string.IsNullOrEmpty(TXT_login.Text) || string.IsNullOrEmpty(TXT_pass.Password))
            {
                MessageDialog messageBox = new MessageDialog("Vous devez renseignez les deux champs pour continuer.");
